...
provides and how they differ. Use concrete examples showing the import from the
correct source package.

Correct:

```markdown
Types and constructors come from `@eserstack/primitives`: import * as results
from "@eserstack/primitives/results";

Pure FP utilities come from `@eserstack/fp`: import * as fp from
"@eserstack/fp";
```
