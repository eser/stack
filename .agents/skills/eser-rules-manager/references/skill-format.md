...
**"This is a special case"** No. The rule applies to ALL cases. Ask for explicit
exception approval.

**"I already tested it manually"** Manual testing doesn't replace automated
tests. Run the test suite.

**"Being pragmatic means adapting"** Pragmatism doesn't mean skipping quality
gates. Follow the process.
```
...
See the `eser-rules-manager` SKILL.md for the full skill table. Create new
skills for: `ui/`, `testing/` when needed.
