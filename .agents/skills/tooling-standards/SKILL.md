...
**Package manager:** Use `pnpm install/add` for dependencies; use
`pnpm add -g eser` for the CLI tool

**Deno runtime:** Use `deno fmt/lint/test/check/task` for formatting, linting,
testing, and running tasks
