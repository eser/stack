...
- added formatting utilities in @eser/standards for better number, size, duration, and percentage representation.
- introduced new utilities in the @eser/standards package, including date and time formatting, internationalization, and string interpolation functions.
...
- **@eser/cs:** remove builders and config files; update CLI and generate functionality
