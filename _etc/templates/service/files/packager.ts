...
await build({
  ...
  shims: {
    custom: [
      ...
      {
        module:
          "https://deno.land/x/hex@0.5.25/src/shims/error-event/error-event.ts",
        globalNames: [
          {
            name: "ErrorEvent",
  ...
  mappings: {
    "https://deno.land/x/oak@v12.6.0/http_server_native.ts":
      "https://deno.land/x/oak@v12.6.0/http_server_node.ts",
  },
  typeCheck: false,
  test: false,
  declaration: true,
