 ...
 * Add custom routes here that take precedence over auto-generated routes
 * These will be merged with generated routes at build time
 */
export const manualRoutes: RouteDefinition[] = [
  // Example:
