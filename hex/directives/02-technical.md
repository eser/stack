# 📓 [cool/hex/directives/technical](https://github.com/eser/cool/tree/dev/hex/directives/technical)

## Technical Directives

**hex** is the name of the ecosystem, which consists of many sub-components.
Although each component of cool has its own nature, we believe that similar
