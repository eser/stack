...
export interface LimeConfig {
  ...
  // Older versions of cool lime merged the `Deno.ServeTlsOptions` directly.
...
export interface RouterOptions {
  /**
   *  Controls whether cool lime will append a trailing slash to the URL.
   *  @default {false}
   */
   ...
   *
   *  By default cool lime will ignore test files,
...
export interface RouteConfig {
   ...
   * that are generated by cool lime. Additional scripts and styles can be added
