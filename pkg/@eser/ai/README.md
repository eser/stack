...
```bash
# Standalone
deno jsr:@eser/ai ask "explain closures in JS" -p cc
deno jsr:@eser/ai ask "summarize this"              # auto-detect provider
deno jsr:@eser/ai list                               # show available providers
...
### @eser/streams Integration

```typescript
import * as streams from "@eser/streams";
import * as aiStreams from "@eser/ai/streams";
