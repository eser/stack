 ...
 * Resolves JSR imports (@eser/*, jsr:) to actual file paths for bundling
 ...
 *
 * This plugin intercepts @eser/* and jsr: imports and resolves them
...
export function createJsrResolverPlugin(
  ...
  return {
    name: "jsr-resolver",
    setup(build) {
      // Match @eser/* imports (bare specifiers mapped in deno.json)
