 ...
 * while @eser/laroux and @eser/laroux-server remain external (resolved from node_modules at runtime).
 *
 * @module
 */
 ...
 * - "@eser/laroux-server" matches "@eser/laroux-server"
 * - "@eser/laroux-server" matches "@eser/laroux-server/action-registry"
 */
...
export function createServerExternalsPlugin(
  ...
  // e.g., ["@eser/laroux", "@eser/laroux-server"] -> /^(@eser\/laroux|@eser\/laroux-server)($|\/)/
