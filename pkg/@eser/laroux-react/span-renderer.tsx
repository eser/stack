 ...
 *
 * This is an external renderer for `@eser/streams` that lives in
 * `@eser/laroux-react` to avoid coupling streams to React.
 *
 * @example
 * ```tsx
...
import type * as spanTypes from "@eser/streams/span";
import { normalize } from "@eser/streams/span";
import type { Renderer } from "@eser/streams/renderers";
...
/**
 * React renderer — implements the `@eser/streams` Renderer interface.
