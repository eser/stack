...
/**
 * React integration for @eser/functions — run handlers inside
...
/**
 * Run an @eser/functions Task inside a React Server Component.
 *
 ...
 *
 * @param t - A Task from an @eser/functions handler
