...
/**
 * React Adapter for @eser/laroux-server
 *
 ...
 * @example
 * ```ts
 * import { reactRenderer, reactHtmlShellBuilder } from "@eser/laroux-server/adapters/react";
 * import { startServer } from "@eser/laroux-server";
 *
 * await startServer({
 *   mode: "dev",
