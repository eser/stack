...
/**
 * Tailwind CSS plugin for @eserstack/bundler.
 *
 ...
 * @example
 * ```ts
 * import { createTailwindRoot } from "@eserstack/bundler/css/tailwind-plugin";
 * import { processCssModule } from "@eserstack/bundler/css/modules";
 *
