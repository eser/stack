 ...
 * `WorkflowTool` from `@eserstack/workflows` (duck-typed, no import needed).
 *
 * @module
 */
...
/**
 * A tool compatible with the `@eserstack/workflows` engine.
 * Structurally typed — no import from `@eserstack/workflows` required.
 */
 ...
 * `WorkflowTool` from `@eserstack/workflows`.
 */
