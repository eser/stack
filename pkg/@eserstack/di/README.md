...
> `pnpm add jsr:@eserstack/di`

`@eserstack/di` is a crucial component of `eserstack` that provides simple and
...
## 🤔 What @eserstack/di offers?

`@eserstack/di` helps you handle these dependencies by providing a structured,
...
Here you'll find a list of features provided by `@eserstack/di` along with brief
...
```js
import * as di from "@eserstack/di";
