...
/**
 * Adapters for @eserstack/laroux-server
 *
 ...
 * @example
 * ```ts
 * import { reactRenderer } from "@eserstack/laroux-server/adapters";
 * // or
 * import { reactRenderer } from "@eserstack/laroux-server/adapters/react";
 * ```
 */
