...
/**
 * Entry point for the standalone `laroux` binary.
 *
 * The command tree is the module the `eser` CLI mounts at `eser laroux`,
...
if (import.meta.main) {
  await runStandaloneModule(moduleDef, "laroux", config.version);
}
