...
export type BrowserShimsConfig = {
  /**
   * JSR package shims - replaces @eserstack/* and jsr: imports with browser-compatible code
   * Key: package specifier (e.g., "@eserstack/logging")
...
export type UserConfig = {
  ...
  build?: {
     ...
     * These are merged with the defaults: ["@eserstack/laroux", "@eserstack/laroux-server"]
