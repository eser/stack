 ...
 *
 * AI providers = LLM backends (anthropic, openai, etc.) from @eserstack/ai.
...
// =============================================================================
// AI Provider Detection (delegates to @eserstack/ai)
// =============================================================================

export type { ProviderStatus } from "@eserstack/ai/mod";
