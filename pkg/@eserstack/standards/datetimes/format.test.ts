...
Deno.test("toISODate - formats date correctly", () => {
  ...
  assert.assertEquals(toISODate(date), "2024-03-15");
});

Deno.test("toISODate - handles different dates", () => {
  assert.assertEquals(
    toISODate(new Date("2024-01-01T00:00:00Z")),
    "2024-01-01",
  );
  assert.assertEquals(
    toISODate(new Date("2024-12-31T23:59:59Z")),
    "2024-12-31",
  );
});
